...
$(document).ready(function() {
  //At the start I have an anchor tag when I click on it I want to pass in the event
  ...
  ///Allow its to act like a radio button
  ...
  $(".quiz a").click(function(e) {
    ...
    if ($("li.selected").length) {
      //We need to get what they select but more specificially that id
      let guess = parseInt($("li.selected").attr("id"));
      //if you aren't sure that worked this allows you to test it
      console.log(guess);
    } else {
    }
  });
